...
#class that contains the items to be fetched
class bio:
    def __init__(self):
        self.name=""
        self.href=""
...
for person in names:
    ...
    print(f"the link is : {person.href}")
    print(f"the height is : {person.height}")    
    print(f"the weight is : {person.weight}")    
    print(f"the dob is : {person.dob}")